...
const CONFIG = {
  ...
  accounts: {
    groom: [
      { role: "신랑", name: "Jiyoon Kim", bank: "e-Transfer:", number: "core_1006@hotmail.com" }
    ],
    bride: [
      { role: "신부", name: "Joy Kim", bank: "e-Transfer:", number: "kimjoy1009@gmail.com" }
    ]
  },
